...
def main(smiles_file, fragment_library_file):
    ...
    selector = joblib.load('models/cdk9-models/feature_selector.pkl')
    new_features_selected = selector.transform(new_features)
    print(f"Selected features shape: {new_features_selected.shape}")

    # Load ensemble model
    print("Loading ensemble model...")
    ensemble_model = joblib.load('models/cdk9-models/ensemble_model.pkl')
...
if __name__ == "__main__":
    main('test/test_small.csv', 'data/cdk9-fragments.csv')